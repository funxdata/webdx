...
): (line: Uint8Array, fieldLength: number) => void { // 添加了返回类型
...
const concat = (a: Uint8Array, b: Uint8Array): Uint8Array => { // 添加了返回类型
...
const newMessage = (): EventSourceMessage => { // 添加了返回类型
  return {
    data: "",
    event: "",
    id: "",
